...
% EC.N.ECq(t/dtM) = sum(EC.ECdt(tk0:tk1,DepQueueAircraft),'all');
% EC.N.EC(t/dtM) = sum(EC.ECdt(tk0:tk1,ActiveAircraft),'all');
% [EC.EC_Std,EC.EC_Mean,EC.EC_Var] = CalStd(EC.ECdt,dtM,dtS);
% EC.N.EC_Std(t/dtM) = EC.N.EC_Std(ts:te);
% EC.N.EC_Mean(t/dtM) = EC.N.EC_Mean(ts:te);
% EC.N.EC_Var(t/dtM) = EC.N.EC_Var(ts:te);
% ========================================================================
% MIS
